...
public class CorrelationStatisticsNodeSpearmanUI implements StatisticsUI {
    
    DelegateUserInterface ui;
    
    public CorrelationStatisticsNodeSpearmanUI() {
        ui=new DelegateUserInterface(DelegateCorrelationStatistics.CorrelationType.NODE_SPEARMAN,
                CorrelationStatisticsNodeSpearman.class);
    }
