...
public class CorrelationStatisticsEdgeSpearmanUI implements StatisticsUI {
    
    DelegateUserInterface ui;
    
    public CorrelationStatisticsEdgeSpearmanUI() {
        ui=new DelegateUserInterface(DelegateCorrelationStatistics.CorrelationType.EDGE_SPEARMAN,
                CorrelationStatisticsEdgeSpearman.class);
    }
