...
public class CorrelationStatisticsNodePearsonUI implements StatisticsUI {
    
    DelegateUserInterface ui;
    
    public CorrelationStatisticsNodePearsonUI() {
        ui=new DelegateUserInterface(DelegateCorrelationStatistics.CorrelationType.NODE_PEARSON,
                CorrelationStatisticsNodePearson.class);
    }
